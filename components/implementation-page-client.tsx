...
export function ImplementationPageClient({ opportunity }: { opportunity: any }) {
  ...
  const calculateSprintMetrics = () => {
    if (jiraConnected && jiraIssues.length > 0) {
      ...
      return {
        ...
        total,
        percentage,
        velocity: Math.round(completed * 1.5),
      }
    }
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="text-sm font-medium">
                    {opportunity.businessSponsor || opportunity.business_sponsor}
                  </div>
                </div>
                <div>
                  <h4 className="mb-2 text-sm font-medium text-muted-foreground">Business Team</h4>
                  <div className="text-sm font-medium">{opportunity.businessTeam || opportunity.business_team}</div>
                </div>
              </div>
              <div>
